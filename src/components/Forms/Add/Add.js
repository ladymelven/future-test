...
class Add extends React.Component {
	...
	render() {
		//по дефолту есть только кнопка "Добавить"
		let component = (
		...
		/*По клику рендерится сама форма. Можно бы вынести инпут в отдельный компонент,
		но это еще один слой передачи данных, и они идут не вместе с лейблами, поэтому так*/
